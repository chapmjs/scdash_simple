...
server <- function(input, output) {
  ...
  output$inventoryPlot <- renderPlot({
    ...
    cm1 <- part# Load required libraries
    library(shiny)
    library(DT)
    library(ggplot2)
    library(dplyr)
    ...
    server <- function(input, output) {
      ...
      CM #1 Inventory`
      cm2 <- part# Load required libraries
      library(shiny)
      library(DT)
      library(ggplot2)
      library(dplyr)
      ...
      server <- function(input, output) {
        ...
        CM #2 Inventory`
        oem <- part# Load required libraries
        library(shiny)
        library(DT)
        library(ggplot2)
        library(dplyr)
        ...
        server <- function(input, output) {
          ...
          ggplot(plot_data, aes(x = Location, y = Inventory, fill = Location)) +
            ...
            theme_minimal() +
            labs(title = paste("Inventory Levels for", part# Load required libraries
                               library(shiny)
                               library(DT)
                               library(ggplot2)
                               library(dplyr)
